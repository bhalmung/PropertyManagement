var DNNModule1 = DNNModule1 || {};

DNNModule1.itemViewModel = function (moduleId, resx) {
    var service = {
        path: "DNNModule1",
    ...
    var loadUsers = function (data) {
        ...
        for (var i = 0; i < data.length; i++) {
            var result = data[i];
            var user = new DNNModule1.user(result.id, result.name);
...
DNNModule1.user = function (id, name) {
    this.id = id;
    this.name = name;
}